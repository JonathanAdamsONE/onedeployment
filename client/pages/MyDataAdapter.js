...
import { DeviceData, AggregatedValues } from "../../node_modules/forge-dataviz-iot-data-modules/client/data/Hyperion.Data.DataModel";
import { getTimeInEpochSeconds, getPaddedRange } from "../../shared/Utility";
import { DateTimeSpan } from "../../node_modules/forge-dataviz-iot-data-modules/client/data/Hyperion.Data.Storage";
 ...
 */
 export class MyDataAdapter extends DataAdapter {
    /**
        ...
        return Promise.all(promises).then((deviceInfosList) => {
            ...
            deviceModels.forEach((deviceModel, index) => {
                ...
                deviceInfos.forEach((deviceInfo) => {
                    ...
                    device.floorId = deviceInfo.floorId;
                    device.dbId = deviceInfo.dbId;
