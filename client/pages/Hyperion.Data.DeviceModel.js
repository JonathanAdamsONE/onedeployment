...
export class Device {
    ...
    /**
     * @param {string} value The floor which the device is on.
     */
     set floorId(value) {
        this._floorId = value;
    }
    ...
    /**
     * @param {string} value The dbId for the model the device is linked to
     */
     set dbId(value) {
        this._dbId = value;
    }
    ...
    /**
     * @returns {string} The floor the device is on.
     */
     get floorId() {
    ...
    /**
     * @returns {string} The dbId of the model the device is linked to.
     */
     get dbId() {
        return this._dbId;
    }
