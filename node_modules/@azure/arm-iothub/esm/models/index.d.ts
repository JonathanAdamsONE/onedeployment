 ...
 * @enum {string}
 */
export declare type RoutingSource = 'Invalid' | 'DeviceMessages' | 'TwinChangeEvents' | 'DeviceLifecycleEvents' | 'DeviceJobLifecycleEvents' | 'DigitalTwinChangeEvents';
/**
 ...
 * @enum {string}
 */
export declare type Encoding = 'Avro' | 'AvroDeflate' | 'JSON';
/**
 ...
 */
export declare type IotHubResourceDeleteMethodResponse = {
    /**
 ...
 */
export declare type IotHubResourceBeginCreateOrUpdateResponse = IotHubDescription & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type IotHubResourceBeginUpdateResponse = IotHubDescription & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type IotHubResourceBeginDeleteMethodResponse = {
    /**
     * The parsed response body.
     */
    body: any;
 ...
 * Contains response data for the list operation.
 */
export declare type PrivateEndpointConnectionsListResponse = Array<PrivateEndpointConnection> & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginDeleteMethod operation.
 */
export declare type PrivateEndpointConnectionsBeginDeleteMethodResponse = PrivateEndpointConnection & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
